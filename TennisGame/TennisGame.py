class TennisGame:
    ...
    def has_winner(self):
        return (self.player_one_score >= 4 and self.player_one_score >= self.player_two_score + 2) or \
               (self.player_two_score >= 4 and self.player_two_score >= self.player_one_score + 2)

    def has_advantage(self):
        return (self.player_one_score >= 4 and self.player_one_score == self.player_two_score + 1) or \
               (self.player_two_score >= 4 and self.player_two_score == self.player_one_score + 1)
